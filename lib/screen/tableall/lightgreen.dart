...
void main() {
  runApp(const LightgreenPage());
}

class LightgreenPage extends StatelessWidget {
  const LightgreenPage({Key? key}) : super(key: key);
        ...
        child: Row(
          ...
          children: [
            Row(
              children: [
                CircleAvatar(
                  backgroundColor: const Color.fromARGB(255, 207, 243, 189),
                  child: Icon(
                    flightIcon,
                    size: 28,
                    color: const Color.fromARGB(255, 47, 153, 58),
                  ),
                ),
