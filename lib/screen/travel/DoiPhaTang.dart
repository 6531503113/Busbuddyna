...
class DoiPhaTangScreen extends StatelessWidget {
  const DoiPhaTangScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Doi Pha Tang'),
          ...
          child: Column(
            children: [
              ClipRRect(
                ...
                child: Image.asset(
                  'assets/images/DoiPhaTang.jpg', // ใช้รูปจาก assets
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      '''Doi Pha Tang is located in Chiang Rai, known for its natural beauty and cool climate.''',
                      style: TextStyle(
                        fontSize: 18,
                        height: 1.6,
                    ...
                    Container(
                      ...
                      child: const Text(
                        '''Location: Chiang Rai Province\nOpening Hours: 8:00 AM - 5:00 PM\nEntry Fee: Free\nTransportation: Take the Chiang Saen bus to reach the area''',
                        style: TextStyle(
                          fontSize: 16,
                          height: 1.5,
