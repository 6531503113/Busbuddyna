...
class WatRongSueaTenPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Wat Rong Suea Ten, Chiang Rai'),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Description
                const Text(
                  '''Wat Rong Suea Ten, also known as the Blue Temple, is a Buddhist temple located in Chiang Rai, Thailand. It is known for its vibrant blue color and unique architecture.''',
                  style: TextStyle(
                    fontSize: 18,
                    color: Colors.black,
                    height: 1.6,
