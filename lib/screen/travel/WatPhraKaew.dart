...
class WatPhraKaewPage extends StatelessWidget {
  const WatPhraKaewPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Wat Phra Kaew'),
      ...
      body: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: [
              const Color.fromARGB(255, 255, 254, 255), // สีม่วงเข้ม
          ...
          child: Column(
            children: [
              ClipRRect(
                ...
                child: Image.asset(
                  'assets/images/WatPhraKaew.jpg', // ใส่รูปภาพจาก assets
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      '''Wat Phra Kaew is a Buddhist temple located in Chiang Rai, Thailand. It is an important cultural and historical landmark.''',
                      style: TextStyle(
                        fontSize: 18,
                        height: 1.6,
                        color: Colors.black, // ให้ข้อความเป็นสีขาว
